...
<?php $options = get_option( 'mstoreapp_push' ); ?>
    ...
    public function mstoreapp_prepare_order_query( $args, $request ){
        ...
        if(isset($_REQUEST['vendorid'])) {
            if(is_plugin_active( 'dokan-lite/dokan.php') || is_plugin_active( 'dokan/dokan.php' )){
                ...
                $orders = dokan_get_seller_orders( $_REQUEST['vendorid'], 'all', null, $per_page, $offset );
            ...
            else if(is_plugin_active( 'dc-woocommerce-multi-vendor/dc_product_vendor.php' ) || is_plugin_active( 'wc-multivendor-marketplace/wc-multivendor-marketplace.php' )){            
                global $wpdb;
    ...
    /* For Search_System */
    public function save_search_post( $post_id ) {
        ...
        $results = $wpdb->get_results ("SELECT * FROM $table_name WHere (keyword = '". $title ."')"); 
        ...
        //  هي كل اللي بحثوا عن البرودكت المفروض ابعتها في اي مكان ؟ devices
